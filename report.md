...
```
Ця команда відкриває інтерактивну консоль psql всередині контейнера Postgres, підключаючись до бази _lab4autoservice-db-1_ під користувачем _autoservice_user_. На Рисунку 2 показано підключення до БД через psql у контейнері.
